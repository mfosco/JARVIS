...
# outline taken from tensorflow tutorial on layers
...
def cnn_model_fn(features, labels, mode):
    ...
    Pooling Layer 1      : performs max pooling on a 2x2 filter and stride of 2
    ...
    Dense Layer 2        : 10 neurons, for for each digit target class (0-9)
    '''

    # input layer
    # -1 one indicates the batch size should be dynamically computed based on the
    # number of input values in features['x']
